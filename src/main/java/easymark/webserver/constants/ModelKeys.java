...
public class ModelKeys {
    ...
    public static final String ASSIGNMENTS_PER_CHAPTER = "assignmentsPerChapter";
    ...
    public static final String NEW_CAT = "newCat";
    public static final String NAME_PER_PARTICIPANT = "namePerParticipant";
